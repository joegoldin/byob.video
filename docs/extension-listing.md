...
## Summary
Watch videos together in sync with byob.video — synchronized playback for YouTube, direct video files, and any streaming site with the extension's video hooking.
