      ...
      <div class="card bg-base-200 shadow-xl p-10 text-center items-center max-w-lg">
        ...
        <div class="space-y-2 text-sm text-base-content/50 mb-6">
          <div class="flex items-center gap-2 justify-center">
            ...
            <span>YouTube with SponsorBlock</span>
          </div>
          <div class="flex items-center gap-2 justify-center">
          ...
          <div class="flex items-center gap-2 justify-center">
            ...
            <span>Any site via <a href="https://github.com/joegoldin/byob.video/releases" class="link link-primary">browser extension</a></span>
          </div>
        </div>
